                                        ...
                                        if cur_cycle < MIN_CYCLES_BEFORE_TRADE:
                                            ...
                                            if not candles_for_open_skip:
                                                ...
                                                if pos_info is not None:
                                                    ...
                                                    # v3.52.93: КРИТИЧНЫЙ ФИКС — у РЕАЛЬНОГО успешного
                                                    # открытия сделки не было ВООБЩЕ НИКАКОГО алерта.
                                                    # Все алерты, добавленные в этой серии (v3.52.85-87),
                                                    # были только про ЗАБЛОКИРОВАННЫЕ/отфильтрованные
                                                    # сигналы ("сигнал X пропущен") — а самое важное
                                                    # событие, реальный вход настоящими деньгами, молча
