...
SLOW_IMPULSE_MIN_VOLUME_USD = 150_000    # v0.30.29: реальная находка — 4 их сигнала (HAEDAL/ERA/BLESS/XPIN) НИ РАЗУ не попали ни в живой сканер, ни в диагностику, хотя цифры (дистанция/моментум) подходили — оказалось, их объём $180-810к, наш общий порог ликвидности $3млн (в 4-15 раз выше), они физически невидимы для _fetch_all_symbols(). Вход у slow_impulse — лимитка на EMA-уровне, не срочный рыночный ордер, риск проскальзывания на неликвиде меньше, чем у пампа/дампа — свой, более низкий порог, не трогая общий /scan_settings
